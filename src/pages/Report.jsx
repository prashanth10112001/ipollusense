...
//       response.data.data
//         ? console.log("reports", response.data.data[0].startTime)
          ...
          <Table sx={{ minWidth: 1200 }}>
            ...
            <TableBody>
              {reports.map((report, index) => (
                ...
                >
                  <TableCell>{report?.nodeValue ?? "N/A"}</TableCell>
                  <TableCell>{report?.startTime ?? "N/A"}</TableCell>
                  <TableCell>{report?.endTime ?? "N/A"}</TableCell>

                  <TableCell
                    sx={{
                      color: getAQIColor(report?.avgAQI ?? 0),
                      fontWeight: "bold",
                    }}
                  >
                    {report?.avgAQI != null ? report.avgAQI.toFixed(2) : "N/A"}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell sx={{ color: "red" }}>
                    {report?.dominantPollutant ?? "N/A"}
                  </TableCell>
                  <TableCell>
                    {report?.powerConsumption != null
                      ? `${report.powerConsumption} kWh`
                      : "N/A"}
                  </TableCell>
                  <TableCell
                    sx={{
